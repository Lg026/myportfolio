...
import TRimage from './imgs/typo-rec.png'
  ...
  return (
    <>
        ...
        <div className={projectStyles.container}>
          ...
          <Card title='Typology recs' description='An app that gives you movie recommendations based on a test made using TypeScript' imgSrc={TRimage} url='https://lg026.github.io/typology-recs/'/>
        </div>
    </>
  )
}
